...
public class Service {
	//Overriding getEmployeeDetails method to get details from user and setting the values in the employee class
	...
	// FindInsuranceDetails method is overloaded to find the Insurance Scheme regarding salary
